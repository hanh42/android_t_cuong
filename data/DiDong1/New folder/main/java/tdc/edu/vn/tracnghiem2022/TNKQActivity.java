...
public class TNKQActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getLayoutInflater().inflate(R.layout.tnkq_layout, frameLayout,true);
        ListView questionList = findViewById(R.id.listDrawer);
        Button btn_pre = findViewById(R.id.btn_pre);
        Button btn_mid = findViewById(R.id.btn_mid);
        Button btn_next = findViewById(R.id.btn_next);
        ArrayAdapter<AbtracQuestion> adapter = new ArrayAdapter<AbtracQuestion>(this,android.R.layout.simple_list_item_1,Questions.questions);
    ...
    protected void onResume() {
        super.onResume();
        updateUI();
        //navigation Draver: bieu tuong tran action bar
        ...
        drawerToggle.syncState();//Dong bo hoa trang thai
    }
