...
public class MyNotificationRecyclerViewAdapter extends RecyclerView.Adapter<MyNotificationRecyclerViewAdapter.MyViewHolder> {
    ...
    public MyNotificationRecyclerViewAdapter(Activity activity, int layout_ID, ArrayList<Notification> arrayList) {
    ...
    @NonNull
    @Override
    public MyNotificationRecyclerViewAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull MyNotificationRecyclerViewAdapter.MyViewHolder holder, @SuppressLint("RecyclerView") int position) {
    ...
    public void setOnRecyclerViewOnClickListener(MyNotificationRecyclerViewAdapter.onRecyclerViewOnClickListener onRecyclerViewOnClickListener) {
