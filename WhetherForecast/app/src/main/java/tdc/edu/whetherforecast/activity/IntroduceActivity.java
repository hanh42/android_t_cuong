...
import tdc.edu.whetherforecast.adapter.MySlideIntroduceAdapter;

public class IntroduceActivity extends AppCompatActivity {
    private Button prev, next;
    private ViewPager mSliderViewPaper;
    private LinearLayout mDoLayout;
    private MySlideIntroduceAdapter sliderAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        anhXa();
        sliderAdapter = new MySlideIntroduceAdapter(this);
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (mDot.length - 1 > curentPage) {
                    ...
                    //Event when last slide and lick finish
